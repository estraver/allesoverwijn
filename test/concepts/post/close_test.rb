    ...
    params = ActionController::Parameters.new(
        ...
        blog: {
            post_attributes: {
                ...
                retained_picture: '',
                category_attributes: op.contract.post.categories.collect { |category| {id: category.id} },
                tags_attributes: op.contract.post.tags.collect { | tag | {tag: tag.tag} },
                published_on: op.contract.post.published_on
            }
        },
